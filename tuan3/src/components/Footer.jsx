  ...
  return (
    <div id="footer">
          ...
          <div className="column recipe">
            <h4>Recipes</h4>
            <a className='footer-item recipe-item' href="#">What to Cook This Week</a>
            <a className='footer-item recipe-item' href="#">Pasta</a>
            <a className='footer-item recipe-item' href="#">Dinner</a>
            <a className='footer-item recipe-item' href="#">Healthy</a>
            <a className='footer-item recipe-item' href="#">Vegetarian</a>
            <a className='footer-item recipe-item' href="#">Vegan</a>
            <a className='footer-item recipe-item' href="#">Chrismas</a>
          </div>
          </div>
        </div>
  )
